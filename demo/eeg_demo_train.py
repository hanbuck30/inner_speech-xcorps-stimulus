...
class WindowClass(QMainWindow):
    ...
    def btn_1_clicked(self):
        ...
        target=["taking","sending","turn off","turn on","opening","closing","backward","forward","thank you","sorry"]
    ...
    def record(self):
        ...
        if target[ran_n] == "taking":
            a = 2
        elif target[ran_n] == "sending":
            a = 3
        elif target[ran_n] == "turn off":
            a = 4
        elif target[ran_n] == "turn on":
            a = 5
        elif target[ran_n] == "opening":
            a = 6
        elif target[ran_n] == "closing":
            a = 7
        elif target[ran_n] == "backward":
            a = 8
        elif target[ran_n] == "forward":
            a = 9
        elif target[ran_n] == "thank you":
            a = 10
        elif target[ran_n] == "sorry":
            a = 11                       
...
class protocol(WindowClass):
    ...
    def random(self):
        ...
        label3.setGeometry(1200,530,1500,320)
        label3.show()
    ...
    def point1(self):
        ...
        label4.setGeometry(1200,530,1500,320)
        label4.show()
